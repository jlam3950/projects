...
//generate now apple once apple is eaten

function randomApple(){
    do{
        appleIndex= Math.floor(Math.random() * squares.length)
    } while (squares[appleIndex].classList.contains('snake')) //making sure the apples...
...
function control(e){
    ...
    if(e.keyCode === 39){
        ...
        direction = -1 // if we press lef, the snake will go left one div
    } else if (e.keyCode === 40){
        direction = +width //press down, snake will instantly appear in the div tens from where you are now
    }
 }
